...
// Source: ../db/db_iface.go
//
// Generated by this command:
//
//	mockgen -source ../db/db_iface.go -destination mock_db/mock_db.go
//
...
func (m *MockDB) InsertSession(ctx context.Context, sessionInfo *db.InsertSession) (ccc.UUID, error) {
	m.ctrl.T.Helper()
...
func (m *MockDB) Session(ctx context.Context, sessionID ccc.UUID) (*db.Session, error) {
	m.ctrl.T.Helper()
