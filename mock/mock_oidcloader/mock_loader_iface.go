...
// Source: ../internal/oidcloader/loader_iface.go
//
// Generated by this command:
//
//	mockgen -source ../internal/oidcloader/loader_iface.go -destination mock_oidcloader/mock_loader_iface.go
//

// Package mock_oidcloader is a generated GoMock package.
package mock_oidcloader

import (
	context "context"
	reflect "reflect"

	oidcloader "github.com/cccteam/session/internal/oidcloader"
...
func (m *MockLoader) Provider(ctx context.Context) (oidcloader.Provider, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Provider", ctx)
	ret0, _ := ret[0].(oidcloader.Provider)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
