// package pgcontainer wraps the testcontainers-go package to provide a postgres container for testing.
// This package is intended to be used for testing database calls and migrations.
...
// New returns a new PostgresContainer which represents a newly started docker container running postgres.
...
func (pg *PostgresContainer) CreateDatabase(ctx context.Context, dbName string) (*DB, error) {
